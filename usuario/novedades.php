...
require_once '../superadmin/class/class.codigos_novedades.php';
...
function CamposNovedad(type)
{
	...
	{
		x="<input type='hidden' value='76' id='valor1'/><label>Direccion de Domicilio</label><input type='text' id='direcciondomi'/><label>Telefono</label><input type='text' id='telefono'/>";
	}
